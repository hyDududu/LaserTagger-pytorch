...
def vocab_build(input_file, input_format, vocabulary_size, max_input_examples, enable_swap_tag, output_file):
    data_iterator = utils.yield_sources_and_targets(input_file, input_format)
    phrase_counter, all_added_phrases, max_seq_length = _added_token_counts(data_iterator, enable_swap_tag,
                                                                            max_input_examples)
    matrix = _construct_added_phrases_matrix(all_added_phrases, phrase_counter)
    num_examples = len(all_added_phrases)
